...
const {getToken,allCourses,CalculateRating, calculateNoofLectures,calculateCourseDuration, calculateChapterTime, currency,backendURL,userData} = useContext(AppContext); 
